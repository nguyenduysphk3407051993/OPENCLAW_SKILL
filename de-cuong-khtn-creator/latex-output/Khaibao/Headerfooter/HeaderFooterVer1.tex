...
\def\myfooter{\color{\maunhan} \bfseries\sffamily\faBook\ Đề cương hóa học 6 HKI 2026-2027}
...
\def\Groupzalo{\color{\maunhan}\sffamily\bfseries Nên người - Tiến bộ - Thành đạt }
...
\fancyhead[RO]{}
\cfoot{}
\fancyhead[LE]{\color{\mycolor!30!black}{\Large\fmmfamily\itshape Trường THPT Chi Lăng}}
\fancyhead[RO]{\color{\mycolor!30!black}{\Large\fmmfamily\itshape Trường TH, THCS và THPT Sao Việt}}
...
%     	\path[fill=\mycolor] ($(current page.north west)+(2,-1.6)$) coordinate (A) rectangle ++(\linewidth,-0.05) coordinate (AT);
     	%%% Chân trang lẻ
     	\path ($(current page.south west)+(2,1.2)$) coordinate (B) -- ++(\linewidth,0) coordinate (BT) node [midway](ChanelYT){\myfooter};
