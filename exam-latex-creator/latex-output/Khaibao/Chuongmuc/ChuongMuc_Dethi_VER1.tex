\usepackage{varwidth}
\NewDocumentCommand{\Tieudegiua}{O{\maunhan} O{16pt} m}{%
	\begin{center}
		\begin{tikzpicture}
			\node[
			inner sep=8pt,
			...
			fill=#1!10,
			align=center,
			font=\color{#1!80!black}\fontsize{#2}{6pt}\bfseries\fontfamily{qag}\selectfont
			] (char) {%
	...
	\end{center}
	\vspace{0.3em}%
	{\noindent\large\bfseries Họ và tên học sinh:}\makebox[10.65cm]{\dotfill}\hfill
	{\large\bfseries Lớp:}\makebox[2.65cm]{\dotfill}
}
%%%=========================%%%%
