...
-------------[6] Đánh giá chất lượng không khí tại địa phương (đọc chỉ số AQI, nhận diện nguồn ô nhiễm quanh nhà/trường)
-------------[7] Đề xuất giải pháp giảm ô nhiễm không khí trong sinh hoạt gia đình (hạn chế đốt rác, trồng cây xanh, sử dụng phương tiện xanh...)
-------------[8] Phân tích tác động của ô nhiễm không khí đến sức khỏe con người (bệnh hô hấp, dị ứng, biến đổi khí hậu...)
...
-------------[5] Nhận diện dung dịch, huyền phù, nhũ tương trong đời sống (nước chanh, sữa, nước sông, sốt mayonnaise...)
-------------[6] Ứng dụng hòa tan trong nấu ăn và pha chế (pha nước muối súc miệng, pha sữa, pha thuốc...)
-------------[7] Giải thích hiện tượng thực tế về độ tan (tại sao đường tan nhanh hơn trong nước nóng, muối biển kết tinh khi phơi nắng...)
...
----------[1] Các cấp độ tổ chức của cơ thể đa bào
...
----------[1] Đo chiều dài, khối lượng và thời gian
...
----------[4] Lực cản của nước và không khí
...
----------[1] Chuyển động nhìn thấy của Mặt Trời và Mặt Trăng
...
-------[C] Mở đầu về Khoa học tự nhiên

----------[1] Giới thiệu về Khoa học tự nhiên. Các lĩnh vực chủ yếu của KHTN
...
----------[2] An toàn trong phòng thực hành. Dụng cụ đo, kính lúp và kính hiển vi quang học
